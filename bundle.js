...
function isString$1(value) {
  return typeof value == 'string' ||
    (!isArray(value) && isObjectLike(value) && baseGetTag$2(value) == stringTag);
}
...
function baseIsArguments$1(value) {
  return isObjectLike$4(value) && baseGetTag$4(value) == argsTag;
}
...
var isArguments$1 = baseIsArguments(function() { return arguments; }()) ? baseIsArguments : function(value) {
  return isObjectLike$3(value) && hasOwnProperty$2.call(value, 'callee') &&
...
function baseIsEqual$1(value, other, bitmask, customizer, stack) {
  ...
  if (value == null || other == null || (!isObject$4(value) && !isObjectLike$6(other))) {
    ...
    getData()
      .then(function(json) { 
        ...
        Object.keys(json.movies).forEach(movieID => {
          let theatersShowing = [];
          values_1(json.theaters).forEach(theater => {
            const movieIDs = theater.movies.map(movie => movie.id.toString());
            if (includes_1(movieIDs, movieID)) {
...
function renderMainFragment ( root, component ) {
	...
	var theaterList_initialData = {
		theaters: root.theaters,
		movies: root.movies
	};
	var theaterList = new template.components.TheaterList({
		target: div,
		root: component.root || component,
	...
	return {
		...
		update: function ( changed, root ) {
			var theaterList_changes = {};
			
			if ( 'theaters' in changed ) theaterList_changes.theaters = root.theaters;
			if ( 'movies' in changed ) theaterList_changes.movies = root.movies;
			
			if ( Object.keys( theaterList_changes ).length ) theaterList.set( theaterList_changes );
		},
		
		teardown: function ( detach ) {
			theaterList.teardown( false );
